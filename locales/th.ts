const th = {
  translation: {
    ...
    forgotPassword: {
      ...
      emptyEmailAlert: "กรุณากรอกอีเมลของคุณ",
      successAlert:
        "วิธีการเปลี่ยนรหัสผ่านถูกส่งไปยังอีเมลของคุณแล้ว หากคุณไม่ได้รับอีเมลนี้ กรุณาตรวจสอบกล่องข้อความขยะของอีเมลของคุณ",
    },
    changePassword: {
    ...
    policies: {
      ...
      multinomialText2:
        " ค่าน้ำหนักเป็นจำนวนเต็มที่มีค่าตั้งแต่ 1 ถึง 10 ยิ่งค่าน้ำหนักสูงเท่าใด ความน่าจะเป็นที่จะสุ่มได้ตัวเลือกนั้นก็จะมาขึ้นเท่านั้น ตัวอย่างเข่น ถ้าคุณมี 3 ตัวเลือกที่มีค่าน้ำหนัก 1, 1, 5 ซึ่งรวมกันได้ 7 แล้วความน่าจะเป็นที่จะสุ่มได้ตัวเลือกทั้ง 3 คือ 1/7, 1/7, และ 5/7 ตามลำดับ",
      equalWeightText:
      ...
      ucb1Text:
        "แทนที่จะทำการ explore โดยใช้การสุ่มมั่วๆ UCB1 ทำการสลับขั้นตอนระหว่าง exploration และ exploitation เมื่อมันทำการสุ่มไปเรื่อยๆ ทำการเปลี่ยนจากการที่จดจ่ออยู่กับการ explore ไปที่ตัวเลือกที่ไม่ค่อยจะถูกสุ่ม ไปหาขั้นการ exploit โดยเลือกตัวเลือกที่มี <strong>reward</strong> มากที่สุด",
      ucb1Text2:
      ...
      epsilonGreedyText:
        "Epsilon Greedy หรือ <em>&epsilon;-greedy</em> เป็นวิธีการสุ่มที่ทำการ explore ด้วยความน่าจะเป็น <em>1 - &epsilon;</em> โดยใช้วิธีสุ่มแบบ Equal Weight นอกจากนั้นจะทำการ exploit คือเลือกตัวเลือกที่ดีที่สุด ซึ่ง &epsilon; มีค่าที่เป็นไปได้ในช่วง 0 ถึง 1 ",
      softmaxText:
